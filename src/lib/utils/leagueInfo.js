/*   STEP 1   */
export const leagueID = "1257931186542489600"; // your league ID
export const leagueName = "The Stone Toad Dynasty League"; // your league name
...
export const homepageText = `
  ...
  <p>So enjoy poking around here, all of the stats are pulled from the Sleeper API and everything should be totally accurate, outside of the playoff bracket tab on the matchup page. That section may not be accurate until playoffs begin based on our current H2H tiebreakers and division format. Also, I have no clue how the rest of season power rankings below are calculated, so don't get butthurt thinking its my personal opinion.</p>
  <p>Cheers!</p>
  `;
