...
export const homepageText = `
  ...
  <p>So enjoy poking around here, all of the stats are pulled from the Sleeper API and everything should be totally accurate, outside of the playoff bracket tab on the matchup page. That section may not be accurate until playoffs begin based on our current H2H tiebreakers and division format.</p>
  <p>Cheers!</p>
  `;
